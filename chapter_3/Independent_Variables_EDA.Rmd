...
dat$ASnum[dat$AdoptionSpeed == 4] = 100 + rgeom(sum(dat$AdoptionSpeed == 4), 0.02) #This function rgeom(n, prob) is Geometric Distribution, random generation for the geometric distribution with parameter prob 
summary(dat)
```
...
#Q-Q plot
qqnorm(dat$Fee, main="Q-Q plot of Fee of pets", ylab = "days",col="blue")
qqline(dat$Fee)
```
