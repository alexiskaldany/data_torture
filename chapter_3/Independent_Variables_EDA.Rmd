...
pie(Prop , labels = c(paste("Dog",dog, sep = ":"), paste("Cat",cat, sep = ":")), border="white", col=myPalette )
```
...
```
```{r GENDER}
tmpGender = subset(dat, dat$Gender == "1" | dat$Gender == "2" | dat$Gender == "3")
...
# You can change the border of each area with the classical parameters:
pie(Prop , labels = c(paste("Male", male, sep = ":"),paste("Female", female, sep = ":")), border="white", col=myPalette )
```
...
# You can change the border of each area with the classical parameters:
pie(Prop , labels = c(paste("Small",small, sep = ":"), paste("Medium",medium, sep = ":"), paste("Large",large, sep = ":"), paste("Extra Large",extraLarge, sep = ":")), border="white", col=myPalette )
...
# You can change the border of each area with the classical parameters:
pie(Prop , labels = c(paste("Short",short, sep = ":"), paste("Medium",medium, sep = ":"), paste("Long",long, sep = ":")), border="white", col=myPalette )
```
```{r Vaccinated }
tmpVaccinated = subset(dat, dat$Vaccinated == "1" | dat$Vaccinated == "2")
yesVaccinated = nrow(tmpVaccinated[tmpVaccinated$Vaccinated=="1",])
noVaccinated = nrow(tmpVaccinated[tmpVaccinated$Vaccinated=="2",])
#pie plot
Prop <- c(yesVaccinated,noVaccinated)
# Prepare a color palette. Here with R color brewer:
library(RColorBrewer)
myPalette <- brewer.pal(3, "Set2") 

# You can change the border of each area with the classical parameters:
pie(Prop , labels = c(paste("Vaccinated",yesVaccinated, sep = ":"), paste("No Vaccinated",noVaccinated, sep = ":")), border="white", col=myPalette )
