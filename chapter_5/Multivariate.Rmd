...
```{r results='markup'}
loadPkg("leaps")
reg_model <- regsubsets(ASnum~., data = dat, nbest = 2, method = 'exhaustive')
plot(reg_model, scale = "adjr2", main = "Adjusted R^2")

```

Plotting best model as determined by Adjusted $R^2$ plot
Variables to include Age, Gender, MaturitySize, Furlength, Vaccinated, VideoAmt
