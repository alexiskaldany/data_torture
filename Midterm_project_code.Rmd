...
This is Age. Although this variable is age, it represents months of the pets since they born. It is obviously that most of the pets are small, which is very common sense that their owners do not have enough energy to take care of so many baby pets after their pets give birth to puppies and kittens.  
```{r Age}
tmpDatAge = dat
...
Female animals get adopted quicker than male dogs
